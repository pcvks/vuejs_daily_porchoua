...
export default {
    ...
    methods: {
        ...
        async fetchNote() {
            try {
                const response = await axios.get('https://api-note-dailes.onrender.com/api/note');
        ...
        async deleteNote(noteID) {
            try {
                const response = await axios.delete(`https://api-note-dailes.onrender.com/api/delete-note/${noteID}`);
        ...
        async fetchNoteDetail(Note_ID) {
            ...
            try {
                const response = await axios.get(`https://api-note-dailes.onrender.com/api/note/${Note_ID}`);
        ...
        async updateNote() {
            try {
                const response = await axios.put(`https://api-note-dailes.onrender.com/api/update-note/${this.Note_ID}`, {
