...
export default {
    ...
    methods: {
        ...
        async fetchCountPlan() {
            axios.get('http://localhost:3000/api/count-plan')
                .then(response => {
        ...
        async fetchCountPlanSuccess() {
            axios.get('http://localhost:3000/api/count-plan_success')
                .then(response => {
        ...
        async fetchCountPlanNotYetSuccess() {
            axios.get('http://localhost:3000/api/count-plan_not_yet_success')
                .then(response => {
        ...
        async fetchCountDay() {
            axios.get('http://localhost:3000/api/count-day')
                .then(response => {
        ...
        async fetchSumIncome() {
            axios.get('http://localhost:3000/api/sum-income')
                .then(response => {
        ...
        async fetchSumExpenditure() {
            axios.get('http://localhost:3000/api/sum-expenditure')
                .then(response => {
        ...
        async fetchSumMoneyRemaining() {
            axios.get('http://localhost:3000/api/sum-money_remaining')
                .then(response => {
        ...
        async fetchSumExpenditureToday() {
            axios.get('http://localhost:3000/api/sum-expenditure_today')
                .then(response => {
