...
export default {
    ...
    methods: {
        ...
        async fetchPlans() {
            try {
                const response = await axios.get('https://api-note-dailes.onrender.com/api/plan');
        ...
        async deletePlan(Plan_ID) {
            try {
                const response = await axios.delete(`https://api-note-dailes.onrender.com/api/delete-plan/${Plan_ID}`);
        ...
        async fetchPlanDetails(Plan_ID) {
            ...
            try {
                const response = await axios.get(`https://api-note-dailes.onrender.com/api/plan/${Plan_ID}`);
        ...
        async updatePlan() {
            try {
                const response = await axios.put(`https://api-note-dailes.onrender.com/api/update-plan/${this.Plan_ID}`, {
