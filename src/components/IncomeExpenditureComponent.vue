...
export default {
  ...
  methods: {
    ...
    async fetchExpenditure_s() {
      try {
        const response = await axios.get(
          "http://localhost:3000/api/expenditure"
        );
        if (Array.isArray(response.data)) {
    ...
    async createIncome() {
      try {
        const response = await axios.post(
          "http://localhost:3000/api/create-income",
          {
    ...
    async createExpenditure() {
      try {
        const response = await axios.post(
          "http://localhost:3000/api/create-expenditure",
          {
    ...
    async deleteExpenditure(Expenditure_ID) {
      try {
        const response = await axios.delete(
          `http://localhost:3000/api/delete-daily/${Expenditure_ID}`
        );
    ...
    async deleteIncome(Income_Id) {
      try {
        const response = await axios.delete(
          `http://localhost:3000/api/delete-daily/${Income_Id}`
        );
        console.log(response.data); // Log the response from the server
        Swal.fire({
          title: "ລົບລ້າງ!",
    ...
    async fetchIncomeDetails(Income_ID) {
      ...
      try {
        const response = await axios.get(
          `http://localhost:3000/api/income/${Income_ID}`
        );
    ...
    async fetchExpenditureDetails(Expenditure_ID) {
      ...
      try {
        const response = await axios.get(
          `http://localhost:3000/api/expenditure/${Expenditure_ID}`
        );
    ...
    async updateIncome() {
      try {
        const response = await axios.put(
          `http://localhost:3000/api/update-income/${this.Income_ID}`,
          {
    ...
    async updateExpenditure() {
      try {
        const response = await axios.put(
          `http://localhost:3000/api/update-expenditure/${this.Expenditure_ID}`,
          {
